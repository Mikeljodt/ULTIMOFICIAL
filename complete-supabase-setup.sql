...
CREATE INDEX idx_machine_history_created_by ON public.machine_history (created_by);

-- Índices para instalaciones
CREATE INDEX idx_installation_data_machine_id ON public.installation_data (machine_id);
CREATE INDEX idx_installation_data_created_by ON public.installation_data (created_by);
...
CREATE INDEX idx_maintenance_created_by ON public.maintenance (created_by);
